...
export default function BottomNav() {
  ...
  // Sincronización silenciosa en segundo plano (solo si el permiso ya fue concedido)
  useEffect(() => {
    const user = getUser();
    if (user) {
      import('@/lib/push').then(({ sincronizarPushSilencioso }) => {
  ...
  return (
    <>
      {/* Banner de opt-in para notificaciones (aparece una sola vez) */}
      <NotificationBanner />
